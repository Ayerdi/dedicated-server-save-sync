...
1. Download `dedicated-server-save-sync-client-v2.2.0.zip` and its `.sha256`
   file from release `v2.2.0`.
...
> product release number. The stable product bundle containing it is `v2.2.0`.
